...
class Iterator:
    ...
    def __init__(self, start, stop, step=1):
        ...
        self.start = start    # int - с которого начинается итерация
        self.stop = stop      # int - на котором заканчивается итерация
    ...
    def __iter__(self):      # итератор объекта
